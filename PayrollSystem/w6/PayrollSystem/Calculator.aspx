<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Calculator.aspx.cs" Inherits="PayrollSystem.Calculator" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  Num1: <asp:TextBox ID="txtNum1" runat="server"></asp:TextBox>
    ...
    <br />
    <asp:Button runat="server" ID="cmdCalc" Text="Add!" onclick="cmdCalc_Click" CssClass ="divider" />
    
    <asp:Button ID="btnDivide" runat="server" Text="Divide" CssClass ="divider" 
